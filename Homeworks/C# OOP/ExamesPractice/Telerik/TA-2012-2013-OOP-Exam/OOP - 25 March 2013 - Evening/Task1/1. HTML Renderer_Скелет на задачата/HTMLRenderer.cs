...
namespace HTMLRenderer
{
    ...
    {
        private ICollection<IElement> childEmelents;

        public Element(string name)
        {
            this.Name = name;
            this.childEmelents = new List<IElement>();
        }
        ...
        public virtual IEnumerable<IElement> ChildElements
        {
            get
            {
                return new List<IElement>(this.childEmelents);
            }
        }

        public virtual void AddElement(IElement element)
        {
            this.childEmelents.Add(element);
        }
        ...
        public virtual void Render(StringBuilder output)
        {
            ...
            foreach (var childElement in this.childEmelents)
            {
                output.Append(childEmelents.ToString());
            }
    ...
    public class Table : Element, ITable, IElement
    {
        ...
        private const string TableRCellOpenTag = "<td>";
        ...
        public int Cols
        {
            ...
            private set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException("value", "Html table columns count cannot be negative");
                }
        ...
        public override string TextContent
        {
            get
            {
                throw new InvalidOperationException("Cannot get content of html table because it does not have such!");
            }
            set
            {
                throw new InvalidOperationException("Cannot set content of html table because it does not have such!");
            }
        }
        ...
        public override void Render(StringBuilder output)
        {
            ...
            for (int row = 0; row < this.Rows; row++)
            {
                ...
                {
                    output.Append(TableRCellOpenTag);
        ...
        {
            throw new InvalidOperationException("Html tables do not have child elemets so such cannot be added!");
        }
    ...
    public class HTML : IElement
    {
        private ICollection<IElement> childElements;

        public HTML()
        {
            this.ChildElements = new List<IElement>() { new Element("s") };
        }
